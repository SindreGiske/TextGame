...
public fun setupWorld(): Pair<Room, Player> {
    ...
    val ritualRoom = Room("North room",
        """
    ...
    val eagleObelisk = Asset("Eagle Obelisk",
        ...
        """.trimMargin())
    eagleObelisk.setInteractions(Interaction("light candle", true, matchbox))
    ...
    val snakeObelisk = Asset("Snake Obelisk",
        ...
        """.trimMargin())
    snakeObelisk.setInteractions(Interaction("light candle", true, matchbox))
    ...
    val toadObelisk = Asset("Toad Obelisk",
        ...
        """.trimMargin())
    toadObelisk.setInteractions(Interaction("light candle", true, matchbox))
